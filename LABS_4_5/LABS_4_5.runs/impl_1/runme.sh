...
HD_PWD='C:/GITs/VHDL_Kurssi-master/LABS_4_5/LABS_4_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LABS_4_5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LABS_4_5.tcl -notrace
