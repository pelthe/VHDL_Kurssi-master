...
HD_PWD='C:/GITs/VHDL_Kurssi-master/LABS_4_5/LABS_4_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LABS_4_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LABS_4_5.tcl
