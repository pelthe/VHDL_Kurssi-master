...
HD_PWD='C:/GITs/VHDL_Kurssi-master/LAB_1/LAB_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log integer_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source integer_test.tcl -notrace
