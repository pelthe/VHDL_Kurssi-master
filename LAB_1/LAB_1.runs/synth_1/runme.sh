...
HD_PWD='C:/GITs/VHDL_Kurssi-master/LAB_1/LAB_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log integer_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source integer_test.tcl
