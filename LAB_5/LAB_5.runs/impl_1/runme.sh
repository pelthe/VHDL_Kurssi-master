...
HD_PWD='C:/GITs/VHDL_Kurssi-master/LAB_5/LAB_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LAB_5_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LAB_5_top.tcl -notrace
