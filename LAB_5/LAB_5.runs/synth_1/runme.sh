...
HD_PWD='C:/GITs/VHDL_Kurssi-master/LAB_5/LAB_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LAB_5_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LAB_5_top.tcl
