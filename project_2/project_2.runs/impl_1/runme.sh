...
HD_PWD='C:/GITs/VHDL_Kurssi-master/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_thingy_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_thingy_top.tcl -notrace
