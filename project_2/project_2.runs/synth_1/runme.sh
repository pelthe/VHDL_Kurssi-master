...
HD_PWD='C:/GITs/VHDL_Kurssi-master/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_thingy_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_thingy_top.tcl
